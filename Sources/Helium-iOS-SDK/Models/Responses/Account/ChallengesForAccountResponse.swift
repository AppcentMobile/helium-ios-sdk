//
//  ChallengesForAccountResponse.swift
//  
//
...
public struct ChallengesForAccountResponse : Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([ChallengesForAccountDataResponse].self, forKey: .data)
    }
}

public struct ChallengesForAccountDataResponse: Codable {
    public let type : String?
    public let time : Int?
    public let secret : String?
    public let request_block_hash : String?
    public let path : [ChallengesForAccountPathResponse]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case time = "time"
        case secret = "secret"
        case request_block_hash = "request_block_hash"
        case path = "path"
    ...
    public init(from decoder: Decoder) throws {
        ...
        path = try values.decodeIfPresent([ChallengesForAccountPathResponse].self, forKey: .path)
...
public struct ChallengesForAccountPathResponse : Codable {
    ...
    public init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        witnesses = try values.decodeIfPresent([ChallengesForAccountWitnessesResponse].self, forKey: .witnesses)
        receipt = try values.decodeIfPresent(ChallengesForAccountReceiptResponse.self, forKey: .receipt)
        geocode = try values.decodeIfPresent(ChallengesForAccountGeocodeResponse.self, forKey: .geocode)
...
public struct ChallengesForAccountWitnessesResponse : Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        snr = try values.decodeIfPresent(Int.self, forKey: .snr)
...
public struct ChallengesForAccountGeocodeResponse : Codable {
