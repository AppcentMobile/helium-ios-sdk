...
public struct ValidatorRolesCountsDataResponse: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case vars_v1 = "vars_v1"
        case validator_heartbeat_v1 = "validator_heartbeat_v1"
        case unstake_validator_v1 = "unstake_validator_v1"
        case transfer_validator_stake_v1 = "transfer_validator_stake_v1"
        case transfer_hotspot_v1 = "transfer_hotspot_v1"
        case token_burn_v1 = "token_burn_v1"
        case token_burn_exchange_rate_v1 = "token_burn_exchange_rate_v1"
        case state_channel_open_v1 = "state_channel_open_v1"
        case state_channel_close_v1 = "state_channel_close_v1"
        case stake_validator_v1 = "stake_validator_v1"
        case security_exchange_v1 = "security_exchange_v1"
        case security_coinbase_v1 = "security_coinbase_v1"
        case routing_v1 = "routing_v1"
        case rewards_v2 = "rewards_v2"
        case rewards_v1 = "rewards_v1"
        case redeem_htlc_v1 = "redeem_htlc_v1"
        case price_oracle_v1 = "price_oracle_v1"
        case poc_request_v1 = "poc_request_v1"
        case poc_receipts_v1 = "poc_receipts_v1"
        case payment_v2 = "payment_v2"
        case payment_v1 = "payment_v1"
        case oui_v1 = "oui_v1"
        case gen_gateway_v1 = "gen_gateway_v1"
        case dc_coinbase_v1 = "dc_coinbase_v1"
        case create_htlc_v1 = "create_htlc_v1"
        case consensus_group_v1 = "consensus_group_v1"
        case consensus_group_failure_v1 = "consensus_group_failure_v1"
        case coinbase_v1 = "coinbase_v1"
        case assert_location_v2 = "assert_location_v2"
