...
public struct ListHotspotsForACityResponse : Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([ListHotspotsForACityDataResponse].self, forKey: .data)
    }
}
...
public struct ListHotspotsForACityDataResponse: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        geocode = try values.decodeIfPresent(ListHotspotsForACityGeocodeResponse.self, forKey: .geocode)
        ...
        status = try values.decodeIfPresent(ListHotspotsForACityStatusResponse.self, forKey: .status)
    }
}
