...
public struct GetChainVariablesDataResponse: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case allow_zero_amount
        case alpha_decay
        case batch_size
        case beta_decay
        case block_time
        case block_version
        case chain_vars_version
        case consensus_percent
        case dc_payload_size
        case dc_percent
        case dkg_curve
        case election_bba_penalty
        case election_cluster_res
        case election_interval
        case election_removal_pct
        case election_replacement_factor
        case election_replacement_slope
        case election_restart_interval
        case election_seen_penalty
        case election_selection_pct
        case election_version
        case h3_exclusion_ring_dist
        case h3_max_grid_distance
        case h3_neighbor_res
        case max_open_sc
        case max_payments
        case max_staleness
        case max_subnet_num
        case max_subnet_size
        case max_xor_filter_num
        case max_xor_filter_size
        case min_assert_h3_res
        case min_expire_within
        case min_score
        case min_subnet_size
        case monthly_reward
        case num_consensus_members
        case poc_centrality_wt
        case poc_challenge_interval
        case poc_challenge_sync_interval
        case poc_challengees_percent
        case poc_challengers_percent
        case poc_good_bucket_high
        case poc_good_bucket_low
        case poc_max_hop_cells
        case poc_path_limit
        case poc_target_hex_parent_res
        case poc_typo_fixes
        case poc_v4_exclusion_cells
        case poc_v4_parent_res
        case poc_v4_prob_bad_rssi
        case poc_v4_prob_count_wt
        case poc_v4_prob_good_rssi
        case poc_v4_prob_no_rssi
        case poc_v4_prob_rssi_wt
        case poc_v4_prob_time_wt
        case poc_v4_randomness_wt
        case poc_v4_target_challenge_age
        case poc_v4_target_exclusion_cells
        case poc_v4_target_prob_edge_wt
        case poc_v4_target_prob_score_wt
        case poc_v4_target_score_curve
        case poc_v5_target_prob_randomness_wt
        case poc_version
        case poc_witnesses_percent
        case predicate_callback_fun
        case predicate_callback_mod
        case predicate_threshold
        case price_oracle_height_delta
        case price_oracle_price_scan_delay
        case price_oracle_price_scan_max
        case price_oracle_public_keys
        case price_oracle_refresh_interval
        case reward_version
        case sc_grace_blocks
        case securities_percent
        case snapshot_interval
        case snapshot_version
        case var_gw_inactivity_threshold
        case vars_commit_delay
        case witness_refresh_interval
        case witness_refresh_rand_n
    }
