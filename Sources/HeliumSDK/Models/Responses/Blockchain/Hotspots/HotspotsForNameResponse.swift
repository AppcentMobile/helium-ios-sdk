...
public struct HotspotsForNameResponse: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([HotspotsForNameDataResponse].self, forKey: .data)
    }
}

public struct HotspotsForNameDataResponse: Codable {
    public let address: String?
    public let block: Int?
    public let block_added: Int?
    public let geocode: HotspotsForNameGeocodeResponse?
    ...
    public let status: HotspotsForNameStatusResponse?
    ...
    public init(from decoder: Decoder) throws {
        ...
        geocode = try values.decodeIfPresent(HotspotsForNameGeocodeResponse.self, forKey: .geocode)
        ...
        status = try values.decodeIfPresent(HotspotsForNameStatusResponse.self, forKey: .status)
    }
}

public struct HotspotsForNameGeocodeResponse: Codable {
...
public struct HotspotsForNameStatusResponse: Codable {
